...
public class Sockettest extends Activity {
	...
	public void Snd_txt_Msg(String txt) {
		...
		mensaje.setCuerpo(txt);
		mensaje.setRemitente(miCliente.getInetAddress().toString());
		
		if(txt.equals("INICIARPARTIDA")){
			mensaje.setTipo(1);
			
		}
		if(txt.equals("FINALIZARPARTIDA")){
			mensaje.setTipo(2);
			
		}
		if(txt.equals("REALIZANDOMOVIMIENTO")){
			mensaje.setTipo(4);
		...
		if(txt.equals("ESPERA")){
			mensaje.setTipo(6);
			
		}if(txt.equals("MOVIMIENTOHECHO")){
			mensaje.setTipo(7);
